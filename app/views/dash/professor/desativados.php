...
<div class="container my-5">
    <h2 class="text-center fw-bold py-3" style="background: #9a5c1fad; color: white; border-radius: 12px;">Professores Desativados</h2>
            ...
            <tbody>
                <?php foreach ($professor as $linha): ?>
                    <tr class="fw-semibold">
                        ...
                        <td>
                        <a href="#" class="btn " title="Desativar" onclick="abrirModalAtivar(<?php echo $linha['id_professor'];  ?>)">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Ativar Professor</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Tem Certeza que deseja Ativar esse Professor?</p>
                <input type="hidden" id="idProfessorAtivar" value="">
...
<script>
    function abrirModalAtivar(idProfessor) {
        ...
        document.getElementById('idProfessorAtivar').value = idProfessor;
    ...
    document.getElementById('btnConfirmar').addEventListener('click', function() {
        const idProfessor = document.getElementById('idProfessorAtivar').value;
        console.log(idProfessor);

        if (idProfessor) {
            ativarProfessor(idProfessor);
        }

    });

    function ativarProfessor(idProfessor) {

        fetch(`http://localhost/escola/public/professors/ativar/${idProfessor}`, {
                method: 'POST',
                headers: {
